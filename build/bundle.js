...
var callSiteToString = __webpack_require__(25).callSiteToString
var eventListenerCount = __webpack_require__(25).eventListenerCount
...
var contentDisposition = __webpack_require__(30);
...
var proxyaddr = __webpack_require__(36);
...
var destroy = __webpack_require__(62)
var encodeUrl = __webpack_require__(6)
...
var methods = __webpack_require__(16);
...
var pathRegexp = __webpack_require__(50);
...
var ipaddr = __webpack_require__(66);
...
/* WEBPACK VAR INJECTION */(function(__dirname) {var express = __webpack_require__(39);
var app = express();

var server = app.get("/", function (req, res) {
	return res.sendFile(__dirname + "/public/index.html");
}).use(express.static("public")).listen(process.env.PORT || 5000, function () {
	if (!process.env.PORT) console.log("listening on PORT 5000");
});
...
var proto = __webpack_require__(42);
var Route = __webpack_require__(23);
...
var finalhandler = __webpack_require__(43);
var Router = __webpack_require__(22);
var methods = __webpack_require__(16);
...
var parseUrl = __webpack_require__(5)
var statuses = __webpack_require__(8)
var unpipe = __webpack_require__(49)
...
var accepts = __webpack_require__(70);
var deprecate = __webpack_require__(2)('express');
var isIP = __webpack_require__(20).isIP;
...
var Negotiator = __webpack_require__(71)
